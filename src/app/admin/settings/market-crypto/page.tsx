...
const CRYPTO_PAIRS = allAvailablePairs.filter(
...
export default function AdminCryptoMarketSettingsPage() {
  ...
  const cryptoInterventions = systemSettings.marketInterventions.filter((i) =>
    CRYPTO_PAIRS.includes(i.tradingPair)
  );
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between p-4 rounded-md bg-muted/50">
              <div>
                <Label
                  htmlFor="enable-contract-trading"
              ...
              <Switch
                ...
                onCheckedChange={(checked: boolean) =>
                  updateSetting("contractTradingEnabled", checked)
                }
              />
            </div>
          </CardContent>
