        ...
        <Card className="p-4 space-y-4 relative">
            <div className="flex items-center justify-between">
                <h3 className="font-semibold text-lg flex items-center gap-2">
                 ...
                 <Badge variant={task.status === 'published' ? 'default' : 'secondary'} className={cn(task.status === 'published' && "bg-green-500/80")}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-4">
                     <div className="space-y-2">
                        ...
                        <Input id={`task-title-${task.id}`} value={task.title} onChange={e => updateTask(task.id, { title: e.target.value })} />
                    </div>
                     <div className="space-y-2">
                     ...
                     <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                            <Input 
                                ...
                                className="w-2/3"
                            />
                             <Select value={task.reward_type} onValueChange={(v) => updateTask(task.id, { reward_type: v as any })}>
            ...
            <div className="flex items-center justify-between pt-4 border-t mt-4">
                <div className="flex items-center space-x-2">
                    <Switch
                        ...
                        onCheckedChange={checked => updateTask(task.id, { status: checked ? 'published' : 'draft' })}
                    />
             ...
             <div className="p-4 md:p-8 space-y-6">
                ...
                <Card>
                     <CardHeader>
                        ...
                        <CardDescription>设置前端用户“每日任务”板块内容。可编辑任务标题、内容、奖励规则等。</CardDescription>
                    </CardHeader>
